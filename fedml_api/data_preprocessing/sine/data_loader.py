...
def generate_data_sine(train_iteration, num_client, drift_together, sample_per_client_iter,
...
def load_all_data_sine(batch_size, current_train_iteration, num_client):
    data_path = "./../../../data/sine/"
...
def main():
    ...
    generate_data_sine(2, 2, 0, 500, 1)

    #generate_data_sine(5, 10, 0, 500, 1)
